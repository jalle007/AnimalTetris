...
public class Physics2 extends ApplicationAdapter implements InputProcessor {
    ...
    public void create() {
        ...
        img = new Texture("monkey.png");
        sprite = new Sprite(img);

        sprite.setPosition(-sprite.getWidth()/2,-sprite.getHeight()/4);
...
//                h-10/PIXELS_TO_METERS);
    ...
    private void createWalls() {
        ...
        //bodyDef2.position.set(0,
//                h-10/PIXELS_TO_METERS);
        bodyDef2.position.set(w/2,h/2);
        FixtureDef fixtureDef2 = new FixtureDef();

        EdgeShape edgeShape = new EdgeShape();
        //      edgeShape.set(-w/2,-h/2,w/2,-h/2);
//        edgeShape.set(-w/2,-h/2,100,-200);
    ...
    public boolean touchDown(int screenX, int screenY, int pointer, int button) {
        body.applyForce(0.01f,0.01f,screenX,screenY,true);
